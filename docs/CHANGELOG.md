- Forge Classic 2.28.1: synchronized Generate/Skip/Interrupt progress after prompt expansion, randomized limited positive/negative prompt pairs, fixed partial-batch seed/list alignment, and removed duplicate combinatorial batching of positive/negative prompt cross-products.
